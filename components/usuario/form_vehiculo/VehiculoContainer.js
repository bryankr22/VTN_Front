...
import { Form, Responsive, Button, Dimmer, Loader, Message } from "semantic-ui-react";
    ...
    const publicVehicle = () => {
        ...
        if (isValidForm(dataValid)) {
            ...
            const data = {
                ...
                transmision_vehiculo,
                blindado_vehiculo,
                placa_vehiculo: estado_vehiculo === 'Usado' ? placa_vehiculo : 'Sin Matricular',
                departamento_vehiculo,
                ciudad_vehiculo,
                tipo_moto_select,
                images,
    ...
    return (
        <Form>
            ...
            <Responsive {...Responsive.onlyMobile}>
                <FirstSection data={data} isMobile />
                <Form.Field style={{ marginTop: 20 }}>
                    <label>Agrega una o más fotos (Mínimo 5 fotos)*</label>
