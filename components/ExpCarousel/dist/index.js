...
var placeholderImage = _interopDefault(require('./placeholder~mqAFkmdb.jpg'));
var fallbackImage = _interopDefault(require('./fallback~bcGAFovF.png'));
...
var handleError$1 = function handleError(event) {
  // event.target.src = fallbackImage || fallbackImage.src;
};
...
var GalleryCarousel = function GalleryCarousel(props, ref) {
  var documentRef = React.useRef(isSSR ? undefined : document);
