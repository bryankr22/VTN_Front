    ...
    >
      <nav className="navbar navbar-expand-lg navbar-dark navbar-native-second">
        ...
        <Responsive
          ...
          style={{ display: "contents" }}
        >
          <div className="collapse navbar-collapse" style={{ marginTop: 10 }}>
            <ul
                  ...
                  <div className="item" href="#" style={{ padding: 11 }}>
                    <span>
                      ...
                      >
                        <a
                          onClick={() =>
                            localStorage.setItem("compareVehiculos", "0")
                          }
                          style={{
                            color: "#fff",
                            fontSize: "1rem",
                  ...
                  <div className="item" href="#" style={{ padding: 11 }}>
                    ...
                    >
                      <Link href="/ficha-tecnica">
                        <a
                          onClick={() =>
                            localStorage.setItem("compareFichatecnica", "0")
                          }
                          style={{
                            color: "#fff",
                            fontSize: "1rem",
